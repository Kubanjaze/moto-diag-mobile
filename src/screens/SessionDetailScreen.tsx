...
const useStyles = createThemedStyles((t) => ({
  ...
  rowValueStack: {fontSize: 16, color: t.textPrimary, lineHeight: 20},
  emptyListText: {fontSize: 14, color: t.textMuted, fontStyle: 'italic'},
  notesText: {fontSize: 16, color: t.textPrimary, lineHeight: 20},
  ...
  listBullet: {fontSize: 16, color: t.textMuted, width: 14},
  listItemText: {fontSize: 16, color: t.textPrimary, flex: 1, lineHeight: 20},
  listItemTextMono: {
    fontSize: 16,
    color: t.textPrimary,
    flex: 1,
  ...
  videoRowTitle: {fontSize: 16, color: t.textPrimary, fontWeight: '600'},
  videoRowMeta: {flexDirection: 'row', gap: 12, flexWrap: 'wrap'},
  videoRowMetaItem: {fontSize: 13, color: t.textMuted},
  videoRowPaused: {fontSize: 13, color: t.warning, fontWeight: '600'},
  videoCapPane: {
  ...
  videoCapText: {fontSize: 16, color: t.severity.high.fg, fontWeight: '600'},
  videoCapHint: {fontSize: 14, color: t.severity.high.fg, marginTop: 4},
  ...
  analysisBadgeText: {fontSize: 13, color: t.textSecondary, fontWeight: '600'},
  ...
  findingsAssessment: {fontSize: 16, color: t.textPrimary, lineHeight: 20},
  ...
  findingsDescription: {fontSize: 14, color: t.textSecondary, lineHeight: 18},
  findingsLocation: {fontSize: 13, color: t.textMuted, marginTop: 4},
  findingsEmpty: {fontSize: 14, color: t.textMuted, fontStyle: 'italic', marginTop: 8},
