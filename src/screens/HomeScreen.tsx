...
const useStyles = createThemedStyles((t) => ({
  ...
  subtitle: {fontSize: 14, color: t.textMuted, marginTop: 2, marginBottom: 16},
  section: {
  ...
  sectionBody: {},
  sectionHelp: {fontSize: 16, color: t.textSecondary, marginBottom: 12, lineHeight: 20},
  statusLine: {fontSize: 16, color: t.textSecondary, marginBottom: 4, lineHeight: 20},
  successText: {color: t.success, fontWeight: '600'},
  errorText: {color: t.danger, fontWeight: '600'},
  helpText: {fontSize: 13, color: t.textMuted, marginTop: 4, fontStyle: 'italic'},
  keyMask: {
    fontSize: 14,
  ...
  vehicleLine: {fontSize: 16, color: t.textSecondary, marginLeft: 4, marginTop: 2},
  button: {
  ...
  smallButtonText: {color: t.textSecondary, fontSize: 16, fontWeight: '600'},
  ...
  dangerButtonText: {color: t.danger, fontSize: 16, fontWeight: '600'},
}));
