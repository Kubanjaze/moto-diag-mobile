...
const useStyles = createThemedStyles((t) => ({
  ...
  categoryChipText: {fontSize: 14, color: t.textSecondary},
  ...
  toggleText: {fontSize: 13, color: t.success, fontWeight: '600'},
  linkedSelected: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    alignItems: 'center',
  ...
  linkedSelectedText: {fontSize: 16, color: t.accentPressed, flex: 1},
  linkedClearText: {fontSize: 14, color: t.danger, fontWeight: '600'},
  searchSpinner: {marginTop: 8},
  searchError: {fontSize: 14, color: t.danger, marginTop: 6},
  searchEmpty: {
    fontSize: 14,
    color: t.textMuted,
    fontStyle: 'italic',
  ...
  searchResultName: {fontSize: 16, color: t.textPrimary, fontWeight: '500'},
  searchResultMeta: {fontSize: 13, color: t.textMuted, marginTop: 2},
  footer: {
    padding: 16,
