...
const useStyles = createThemedStyles((t) => ({
  ...
  listBullet: {fontSize: 16, color: t.textMuted, width: 14, marginTop: 1},
  ...
  badgeText: {fontSize: 14, fontWeight: '700', color: t.textSecondary},
  sourceFooter: {
    paddingTop: 12,
    paddingHorizontal: 4,
    alignItems: 'center',
  },
  sourceText: {fontSize: 13, color: t.textMuted, fontStyle: 'italic'},
  ...
  errorHint: {fontSize: 14, color: t.textMuted, marginTop: 12, lineHeight: 18},
