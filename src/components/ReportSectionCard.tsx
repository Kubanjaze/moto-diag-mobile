...
const useStyles = createThemedStyles((t) => ({
  ...
  bulletDot: {fontSize: 16, color: t.textSecondary, lineHeight: 20},
  bulletText: {fontSize: 16, color: t.textPrimary, flex: 1, lineHeight: 20},
  // ---- table variant
  tableRow: {
    flexDirection: 'row',
    paddingVertical: 8,
  ...
  tableCell: {fontSize: 14, color: t.textPrimary, flex: 1},
  ...
  videoFilename: {fontSize: 16, fontWeight: '600', color: t.textPrimary, flex: 1},
  videoMeta: {fontSize: 13, color: t.textMuted, marginTop: 4},
  videoStuckAdvisory: {
    fontSize: 14,
  ...
  findingsAssessment: {fontSize: 16, color: t.textPrimary, lineHeight: 20, marginBottom: 8},
  ...
  findingType: {fontSize: 14, fontWeight: '600', color: t.textPrimary},
  findingSeverity: {
    fontSize: 13,
    fontWeight: '700',
    paddingHorizontal: 6,
  ...
  findingDescription: {fontSize: 14, color: t.textSecondary, marginTop: 4, lineHeight: 18},
  findingMeta: {fontSize: 13, color: t.textMuted, marginTop: 4},
  findingsFooter: {fontSize: 13, color: t.textMuted, marginTop: 6},
  findingsImageQuality: {fontSize: 13, color: t.textMuted, fontStyle: 'italic', marginTop: 2},
