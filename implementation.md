...
**Version:** 0.2.5 | **Date:** 2026-09-04 (Phase 202 — mechanic time tracking; the app's first live-updating display, and the first feature whose point is more than one person using the app)
