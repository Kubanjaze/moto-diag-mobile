...
- **Decision:** Filed as a tracked obligation. Trigger fires on transcript-count, not on a phase boundary — whoever notices the count crossed N picks it up. Phase 195B's plan v1.0 Risk #2 references this ticket as the mitigation.
